...
import { createClient, PostgrestQueryBuilder, RealtimeChannel, SupabaseClient, User, } from '@supabase/supabase-js';

@Injectable({ providedIn: 'root', })
export class Supabase {
  supabaseUrl = 'https://hzbmxexfdjrmwgkayudk.supabase.co';

  publishableKey = 'sb_publishable_Z7uGpewVqLyaVbIcoGdgQA_sCvd2nRV';
